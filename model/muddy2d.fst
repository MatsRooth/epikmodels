...
define ar1 [[[[[[WA | Nst(WA)] ar1] WA] & [[WB ? WB] | [Nst(WB) ? Nst(WB)]]] & [[MA ? MA] | [Nst(MA) ? Nst(MA)]]] & [[MB ? MB] | [Nst(MB) ? Nst(MB)]]];
define ar0 [[[[[[WA | Nst(WA)] ar0] Nst(WA)] & [[WA ? WA] | [Nst(WA) ? Nst(WA)]]] & [[MA ? MA] | [Nst(MA) ? Nst(MA)]]] & [[MB ? MB] | [Nst(MB) ? Nst(MB)]]];
