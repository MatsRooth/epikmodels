...
terms that is defined in Figure 4.  An Epik specifications such as
...
\ex{phenomena1} lists that are covered.
...
The semantic translations in the third column of \ex{lexicon1} use the Epik term
