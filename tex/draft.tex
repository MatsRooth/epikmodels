...
event symbol, $\llbracket e \rrbracket^{\phi,P}$ is the corresponding
...
world-constraints $\phi$.  See this formally in
...
\(
\begin{array}[t]{l|c}
  e & \llbracket e \rrbracket^{\phi, P} \\ \hline  
  u & \{ 00u01, 01u10, 10u11\}\\
  d & \{ 01d00, 10d01, 11d10\}\\
  a_1 & \{10 a_1 10 \}\\
  a_0 & \{01 a_0 01\}\\
...
guarded strings allowed by $\phi$ and $P$. The operation $p + q$ is
...
constraint $\phi$ and the boolean test $t$.  We ``overload'' $\cdot$
...
\begin{figure}
  ...
  \llbracket 0 \rrbracket^{\phi,P} && \{\} \\  
  \llbracket 1 \rrbracket^{\phi,P} && \{\alpha \mid \alpha \Rightarrow \phi\}\\
  \llbracket e \rrbracket^{\phi,P}&& \{\alpha \cdot e \cdot \beta \mid
  (\alpha,\beta) \in P(e), \alpha, \beta \Rightarrow \phi \}
  \\ \llbracket \_ \rrbracket^{\phi,P}&& \bigcup_{e \in
    \dom(P)}\llbracket e \rrbracket^{\phi,P}\\
  \llbracket t \rrbracket^{\phi,P} &&  \{\alpha \mid \alpha \Rightarrow \phi \wedge t\}\\
  \llbracket{p+q}\rrbracket^{\phi,P} && \llbracket{p}\rrbracket^{\phi,P} \cup \llbracket q \rrbracket^{\phi,P}\\
  \llbracket{p \& q}\rrbracket^{\phi,P} && \llbracket{p}\rrbracket^{\phi,P} \cap \llbracket q \rrbracket^{\phi,P}\\
  \llbracket{p;q}\rrbracket^{\phi,P} && \llbracket p \rrbracket^{\phi,P} \cdot \llbracket{q}\rrbracket^{\phi,P}\\
  \llbracket p^*\rrbracket^{\phi,P} && \displaystyle\bigcup_n {\underbrace{\llbracket p \rrbracket^{\phi,P}\cdot \ldots \cdot \llbracket p \rrbracket^{\phi,P}}_{n}} \\
  \llbracket \sim p \rrbracket^{\phi,P} && \llbracket \_^*\rrbracket^{\phi,P} \setminus \llbracket p \rrbracket^{\phi,P} \\
...
\section{Direct Bounded Implementation}
