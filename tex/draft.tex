...
\hspace{2mm}\(\sem{ \Diamond_a\,p } \hspace{4mm}{\triangleq} \hspace{4mm}\{x \mid \exists y . x{\hat{R}_a}y \wedge y \in \sem{ p }^{\epikspec}\} \)
  \caption{Interpretation of Epik terms as sets of guarded strings (Version M)}
  \label{fig:interp2}
\end{figure}
...
{\tt 1}, {\tt u}, and {\tt d}, are symbols.  {\tt a0} and {\tt b0} are special
...
$w_1$ & $1 0$ \\
$w_2$ & $1 0 \,a_0\, 1 0$ \\  
$w_3$ & $0 1 \,a_0\, 0 1 \,b_0\, 0 1$ \\
  \end{tabular}
    \renewcommand{\arraystretch}{1}
\end{example}

Operations such as KAT product are defined operations in the finite
state calculus.



of epistemic KAT in a
