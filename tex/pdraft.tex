...
\title{Epistemic Semantics in Guarded String Models\thanks{Thanks guys.}}
...
\begin{figure}[!t]
  ...
  \newcommand{\hdrspc}{0.3em}
    ...
    \caption{Categorial grammar lexicon. The first column has a word
      ...
      language with lambda. The online supplement includes a version
      of this grammar that can be run using Barker and Shan's chart
      parser for categorial grammar \citep{barker2005parser}.}
  \label{lexiconfigure}
\end{figure} 
