...
implementation of the finite state calculus to a finite state machine with 49 states
and 110 edges, which accepts a countably infinite set of worlds.\footnote{ Machine
...
\(
\begin{array}[t]{l}  
1 0 \; bh \; 1 0 \; ah \; 1 0 \; aht \;  0 1 \\
1 0 \; bh \; 1 0 \; aht \; 0 1 \; at \; 0 1 \\
1 0 \; ah \; 1 0 \; bh \; 1 0 \; aht \; 0 1 \\
\end{array}
\)
\end{example}  
