...
\begin{figure}
  ...
  \semlst{p;q} n &&
  \left(\semlst p n \diamond \semlst q n \right)|_n\\
  \semlst{p^*} n && [] + \left(\semlst p n \diamond \semlst{p^*} {n-i}\right) |_n \\
  ...
  \semlst{\Diamond_a~p } n &&
         [g' \mid g'~\hat{R_a}~g,~\texttt{for}~g~\texttt{in}~\semlst p n]
  \end{array}
  \)
