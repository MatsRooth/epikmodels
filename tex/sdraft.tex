...
semi-privately looking at the coin. The line beginning with {\tt
  ...
  restrict} gives the state formula.  The lines beginning with {\tt
...
\begin{figure}
  \fbox{
    \begin{minipage}{\columnwidth}
      \(\begin{array}{ll}
      \text{events} & e \in \mathsf{P} \\
      \text{states} & \sigma~\text{as in Figure 1} \\    
...
\bibliographystyle{chicago}%{acl_natbib}
